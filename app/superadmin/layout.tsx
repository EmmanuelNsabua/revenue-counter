...
import { LayoutDashboard, Building2, Shield, Sliders, HelpCircle, Settings, Store, Banknote, Users, Activity } from "lucide-react";
...
const superAdminNavItems = [
  ...
  { label: "Audit", href: "/superadmin/audit", icon: Activity },
];
