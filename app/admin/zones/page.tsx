  ...
  return (
    <div className="space-y-6 max-w-7xl pb-16 md:pb-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <ActionButton className="gap-2 w-full sm:w-auto" toastMessage="Création d'une nouvelle zone (en développement).">
          <Plus size={16} />
          Nouvelle Zone
        </ActionButton>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Aucune zone n'a encore été créée pour votre structure. Définissez un premier découpage territorial."
        />
      ) : (
